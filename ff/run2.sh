...
export NVSHMEM_IBGDA_ENABLE_FAULT_TOLERANCE=0
export NVSHMEM_IBGDA_ENABLE_MULTI_PORT=0
export GLOO_SOCKET_IFNAME=enp86s0f0
MASTER_ADDR=10.1.3.201 MASTER_PORT=29501 WORLD_SIZE=2 RANK=1 \
python /workspace/liuda/fault/DeepEP/tests/test_internode.py --pressure-test-mode 0 2>&1 | tee /workspace/liuda/fault/DeepEP/internode_test_node2.log
